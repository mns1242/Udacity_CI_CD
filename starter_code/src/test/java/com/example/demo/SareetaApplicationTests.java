...
public class SareetaApplicationTests {
	...
	public void testGetItemsByName() {
		...
		TestUti.injectObject(itemController, "itemRepository", itemRepository);
		Item item = new Item();
	...
	public void testSubmitOrder() {
		...
		TestUti.injectObject(orderController, "userRepository", userRepository);
		TestUti.injectObject(orderController, "orderRepository", orderRepository);
	...
	public void testFindUserById() {
		...
		TestUti.injectObject(userController, "userRepository", userRepository);
		TestUti.injectObject(userController, "cartRepository", cartRepository);
		TestUti.injectObject(userController, "bCryptPasswordEncoder", bCryptPasswordEncoder);
